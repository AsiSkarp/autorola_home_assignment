...
public class Car {
    ...
    public Car(String vin, String make, String model, LocalDateTime firstRegistration, String mileage, String color, String transmission, LocalDateTime DBEntryTime) {
        this.vin = vin;
        this.make = make;
        this.model = model;
